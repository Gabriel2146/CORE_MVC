<template>
  <div class="exercises-container">
    ...
    <router-link to="/exercises/new" class="btn btn-success">Nuevo Ejercicio</router-link>
...
export default {
  ...
  async mounted() {
    try {
      const res = await axios.get('https://<TU_BACKEND_RENDER_URL>/api/wger/exercises/', {
